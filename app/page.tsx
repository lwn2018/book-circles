    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#121212]">
      ...
      <section className="px-4 pt-12 pb-16 md:pt-20 md:pb-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex items-center justify-center gap-3 mb-8">
            <a 
              href="#" 
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-transparent text-gray-900 dark:text-white transition-colors hover:bg-gray-100 dark:hover:bg-white/10"
            >
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-[#1a1a2e] border-t border-gray-200 dark:border-gray-800 py-2 px-4 z-50">
        <div className="max-w-md mx-auto flex items-center justify-around">
          <Link 
            href="/auth/signin" 
            className="flex flex-col items-center gap-1 text-[#55B2DE] px-4 py-1"
          >
          ...
          <Link 
            href="/auth/signin" 
            className="flex flex-col items-center gap-1 text-gray-500 dark:text-gray-400 hover:text-[#55B2DE] dark:hover:text-[#55B2DE] transition-colors px-4 py-1"
          >
            <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          >
            ...
            <span className="text-xs font-medium">My Shelf</span>
          </Link>
        </div>
      </nav>
