      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-[#1a1a2e] border-t border-gray-200 dark:border-gray-800 py-2 px-4 pb-[max(0.5rem,env(safe-area-inset-bottom))] z-50">
        <div className="max-w-md mx-auto flex items-center justify-around">
          ...
          >
            ...
            <span className="text-xs font-medium text-gray-500 dark:text-gray-400">Circles</span>
          </Link>
          <Link 
            href="/auth/signin" 
            className="flex flex-col items-center gap-1 px-4 py-1"
          >
            ...
            <span className="text-xs font-medium text-gray-500 dark:text-gray-400">Library</span>
          </Link>
          <Link 
            href="/auth/signin" 
            className="flex flex-col items-center gap-1 px-4 py-1"
          >
            ...
            <span className="text-xs font-medium text-gray-500 dark:text-gray-400">Shelf</span>
          </Link>
        </div>
      </nav>
