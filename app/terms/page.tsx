        ...
        <div className="bg-white dark:bg-[#1E293B] rounded-lg shadow-lg p-6 md:p-8">
          ...
          <div className="prose max-w-none text-gray-700 dark:text-gray-300">
            ...
            <section className="mt-8">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">What PagePass Is</h2>
              <p>
            ...
            <section className="mt-8">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Your Account</h2>
              <p>
            ...
            <section className="mt-8">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Your Content</h2>
              <p>
            ...
            <section className="mt-8">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Book Lending</h2>
              <p>
              ...
              <p className="mt-3">
                <strong className="text-gray-900 dark:text-white">You are responsible for your own books.</strong> PagePass does not guarantee that borrowed books will be returned, returned in good condition, or returned on time. By lending a book through PagePass, you accept the risk that it may be lost or damaged.
              </p>
              <p className="mt-3">
                <strong className="text-gray-900 dark:text-white">You are responsible for returning borrowed books.</strong> When you borrow a book through PagePass, you agree to return it in the condition you received it, within a reasonable time.
              </p>
              <p className="mt-3">
            ...
            <section className="mt-8">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Affiliate Links</h2>
              <p>
            ...
            <section className="mt-8">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Gift Transfers</h2>
              <p>
            ...
            <section className="mt-8">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Disclaimer of Warranties</h2>
              <p>
            ...
            <section className="mt-8">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Beta Program</h2>
              <p>
            ...
            <section className="mt-8">
              <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Changes to These Terms</h2>
              <p>
            ...
            <section className="mt-8">
              ...
              <p className="mt-3">
                <strong className="text-gray-900 dark:text-white">Email:</strong> support@pagepass.app<br />
